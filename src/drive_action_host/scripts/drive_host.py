...
from drive_action_host.srv import *
...
def drive():
    ...
    # Start services
    stop_srv = rospy.Service('stop_drive', Empty, stop_drive_cb)
    lin_srv = rospy.Service('lin_drive', LinDrive, lin_drive_cb)
    ang_srv = rospy.Service('ang_drive', AngDrive , ang_drive_cb)
